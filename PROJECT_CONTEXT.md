...
> Generado por `m360_map.sh`  |  2026-03-18 13:53:23
...
list` |
| `/bitacora/<int:pk>/` | `detail` |
| `/bitacora/create/` | `create` |
| `/bitacora/<int:pk>/update/` | `update` |
| `/bitacora/<int:pk>/delete/` | `delete` |
| `/bitacora/content-blocks/` | `content_blocks` |
| `/bitacora/<int:entry_id>/insert-block/<int:block_id>/` | `insert_content_block` |
