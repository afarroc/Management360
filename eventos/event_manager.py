...
from .models import Event, Task, Project, Status
...
class EventManager:
    ...
    def get_event_by_id(self, event_id):
        try:
            ...
            active_event_data = event_data if event.event_status_id == self.active_status.id else None
            return event_data, active_event_data
