...
# Importar la vista de tareas desde el nuevo archivo
from .tasks_views import task_panel, tasks
from .tasks_views import (
    generate_task_alerts, 
    generate_tasks_overview_alerts, 
    generate_task_performance_alerts
)

# ELIMINAR las siguientes funciones de views.py porque ahora están en tasks_views.py:
# 1. def tasks(request, task_id=None, project_id=None): ... 
# 2. def generate_task_alerts(task_data, user): ...
# 3. def generate_tasks_overview_alerts(tasks_data, user): ...
# 4. def generate_task_performance_alerts(tasks_data, user): ...

# Las demás funciones (para proyectos y eventos) se mantienen en views.py
# ... resto del código ...
# ... otras importaciones ...

# Importar las vistas de proyectos desde el nuevo archivo
from .projects_views import (
    ...
    generate_projects_overview_alerts,
    generate_performance_alerts
)

# ... resto del código ...

# Eliminar o comentar las siguientes funciones que ya están en projects_views.py:
