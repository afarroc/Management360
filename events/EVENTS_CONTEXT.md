...
> Generado por `m360_map.sh`  |  2026-03-19 01:40:07
> Ruta: `/data/data/com.termux/files/home/projects/Management360/events`  |  Total archivos: **237**
...
| `inbox.html` | 282 | `templates/events/inbox.html` |
...
| Archivo | Líneas | Ruta relativa |
|---------|--------|---------------|
| `models.py` | 1110 | `models.py` |

### FORMS (1 archivos)

| Archivo | Líneas | Ruta relativa |
|---------|--------|---------------|
| `forms.py` | 537 | `forms.py` |
...
- línea 11: `class Status(models.Model):`
- línea 20: `class ProjectStatus(models.Model):`
- línea 29: `class TaskStatus(models.Model):`
- línea 39: `class Classification(models.Model):`
- línea 47: `class ProjectState(models.Model):`
- línea 66: `class ProjectHistory(models.Model):`
- línea 78: `class Project(models.Model):`
- línea 138: `class ProjectAttendee(models.Model):`
- línea 146: `class TaskState(models.Model):`
- línea 165: `class TaskHistory(models.Model):`
- línea 177: `class Task(models.Model):`
- línea 254: `class TaskProgram(models.Model):`
- línea 275: `class TaskSchedule(models.Model):`
- línea 444: `class EventState(models.Model):`
- línea 463: `class EventHistory(models.Model):`
- línea 475: `class TagCategory(models.Model):`
- línea 488: `class Tag(models.Model):`
- línea 503: `class Event(models.Model):`
- línea 558: `class EventAttendee(models.Model):`
- línea 571: `class CreditAccount(models.Model):`
- línea 593: `class Room(models.Model):`
- línea 600: `class Message(models.Model):`
- línea 607: `class TaskDependency(models.Model):`
- línea 625: `class ProjectTemplate(models.Model):`
- línea 637: `class TemplateTask(models.Model):`
- línea 652: `class InboxItem(models.Model):`
- línea 863: `class Reminder(models.Model):`
- línea 886: `class InboxItemAuthorization(models.Model):`
- línea 905: `class InboxItemClassification(models.Model):`
- línea 944: `class InboxItemHistory(models.Model):`
- línea 969: `class GTDClassificationPattern(models.Model):`
- línea 1029: `class GTDLearningEntry(models.Model):`
- línea 1058: `class GTDProcessingSettings(models.Model):`
